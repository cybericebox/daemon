...
create unique index if not exists event_challenge_index on event_challenges (event_id, exercise_task_id); -- for checking the challenge name is unique in the event
